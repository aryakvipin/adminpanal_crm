...
class RecentDats extends StatefulWidget {
  const RecentDats({
    Key? key,
  }) : super(key: key);

  @override
  State<RecentDats> createState() => _RecentDatsState();
}

class _RecentDatsState extends State<RecentDats> {
...
//          DataCell(
//           GestureDetector(
//               child: Text(fileInfo.title!,style: TextStyle(color: Colors.white),)
//
//           ),
//
//            onTap: () {
